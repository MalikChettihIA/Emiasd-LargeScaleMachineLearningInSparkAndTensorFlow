...
// MAGIC %md
// MAGIC # Regression Tree Induction in Spark ML
...
// MAGIC %md ### Setting0: use the preprocessed data 
...
val tmp_qlqchose = bucketedData.drop("yearOfRegistration")
...
// MAGIC %md ### Setting1: impute the missing data 
